...
| useNewUpdaterImplementation                                           |    `boolean`    | Use the new unified trip update implementation. When true, uses the new format-independent implementation shared by SIRI-ET and GTFS-RT. When false (default), uses the legacy GtfsRealTimeTripUpdateAdapter. | *Optional* | `false`              |  2.9  |
