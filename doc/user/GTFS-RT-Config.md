...
| useNewUpdaterImplementation                                           |    `boolean`    | Use the new unified trip update implementation. When true, uses the new DefaultTripUpdateApplier with common handlers. When false (default), uses the legacy GtfsRealTimeTripUpdateAdapter. | *Optional* | `false`              |  2.9  |
