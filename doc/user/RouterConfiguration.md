...
| [warmup](#warmup)                                                                         |        `object`       | Configure application warmup by running transit searches during startup.                                                                                                                                             | *Optional* |                |  2.9  |
|    [api](#warmup_api)                                                                     |         `enum`        | Which GraphQL API to use for warmup queries.                                                                                                                                                                         | *Optional* | `"transmodel"` |  2.9  |
|    from                                                                                   |        `object`       | Origin location for warmup searches.                                                                                                                                                                                 | *Optional* |                |  2.9  |
|       lat                                                                                 |        `double`       | Latitude of the origin.                                                                                                                                                                                              | *Required* |                |  2.9  |
|       lon                                                                                 |        `double`       | Longitude of the origin.                                                                                                                                                                                             | *Required* |                |  2.9  |
|    to                                                                                     |        `object`       | Destination location for warmup searches.                                                                                                                                                                            | *Optional* |                |  2.9  |
|       lat                                                                                 |        `double`       | Latitude of the destination.                                                                                                                                                                                         | *Required* |                |  2.9  |
|       lon                                                                                 |        `double`       | Longitude of the destination.                                                                                                                                                                                        | *Required* |                |  2.9  |
...
**Since version:** `2.9` ∙ **Type:** `enum` ∙ **Cardinality:** `Optional` ∙ **Default value:** `"transmodel"`   
**Path:** /warmup   
**Enum values:** `transmodel` | `gtfs`

Which GraphQL API to use for warmup queries.

Use `transmodel` for the TransModel API or `gtfs` for the GTFS API.
