...
| `GeofencingBusinessAreaBorders`       | Infer an operational area from GBFS geofencing zones that have no restrictions, preventing rental vehicles from leaving it. This is an OTP-specific concept not defined in the GBFS spec. Disable to avoid inferring operational area boundaries from permissive zones.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |         ✓️         |         |
