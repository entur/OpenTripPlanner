...
/**
 * Tests the {@link RaptorRequestTransferCacheKey} equality/hashing contract: that
 * sub-mode preferences only contribute to the key when the corresponding feature is
 * actually part of the transfer mode. The bucketing transformation is tested separately
 * in {@link TransferRequestBucketerTest}; the rounding primitives in {@link BucketGridTest}.
 */
