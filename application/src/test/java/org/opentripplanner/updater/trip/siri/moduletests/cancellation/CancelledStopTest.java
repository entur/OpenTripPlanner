...
class CancelledStopTest implements RealtimeTestConstants {
  ...
  void testCancelStop() {
    ...
    assertEquals(
      "PATTERN_MODIFIED UPDATED | A 0:01:01 0:01:01 | B [C] 0:01:10 0:01:11 | D 0:01:30 0:01:30",
  ...
  void testCancelledStopWithPredictionInaccurate() {
    ...
    assertSuccess(result);
    assertEquals(
      "PATTERN_MODIFIED UPDATED | A [PI] 0:01:01 0:01:01 | B [C] 0:01:10 0:01:11 | D [PI] 0:01:30 0:01:30",
      env.tripData(TRIP_1_ID).showTimetable()
    );
  }
}
