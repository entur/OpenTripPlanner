...
class UpdatedTimesTest implements RealtimeTestConstants {
  ...
  void testUpdateJourneyWithDatedVehicleJourneyRef() {
    ...
    assertEquals(
      "TIMES_UPDATED | A 0:00:15 0:00:15 | B 0:00:25 0:00:25",
  ...
  void testUpdateJourneyWithRecordedAndEstimatedCalls() {
    ...
    assertSuccess(result);
    assertEquals(
      "TIMES_UPDATED | A [R] 0:00:15 0:00:15 | B 0:00:25 0:00:26 | C 0:00:35 0:00:35",
      env.tripData(TRIP_1_ID).showTimetable()
    );
  }
  ...
  void testUpdateJourneyMultipleTimes() {
    ...
    assertEquals(
      "TIMES_UPDATED | A 0:00:20 0:00:20 | B 0:00:33 0:00:33",
      env.tripData(TRIP_1_ID).showTimetable()
    );
  }
  ...
  void testUpdateJourneyWithPredictionInaccurate() {
    ...
    assertSuccess(result);
    assertEquals(
      "TIMES_UPDATED | A [PI] 0:00:15 0:00:15 | B [PI] 0:00:25 0:00:25",
      env.tripData(TRIP_1_ID).showTimetable()
    );
  }
