...
/**
 * Tests for the preconditions {@link ExistingTripChangeFactory} enforces when it resolves a modification
...
class TripModificationValidationTest {
  ...
  class MinimumStopsTests {
    ...
    private TripModification resolve(ModifyTrip command) {
