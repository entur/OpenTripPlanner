...
class TripModifierTest {
  ...
  class GtfsRtReplacementTests {
    ...
    void replacementTrip_addStop() {
      ...
      var parsedUpdate = TripModification.builder(tripRef, env.defaultServiceDate())
        .withFormatPolicy(
    ...
    void replacementTrip_invalidServiceDate() {
      ...
      var parsedUpdate = TripModification.builder(tripRef, invalidDate)
        .withFormatPolicy(
          FormatPolicy.gtfsRt(ForwardsDelayPropagationType.NONE, BackwardsDelayPropagationType.NONE)
        )
        .addStopTimeUpdate(createStopUpdate("A", 0, 10 * 3600))
    ...
    void replacementTrip_unknownStop() {
      ...
      var ex = assertThrows(UpdateException.class, () ->
        modifier.modify(resolver.resolve(parsedUpdate))
      );
