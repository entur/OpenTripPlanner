 ...
 * be applied to avoid NEGATIVE_HOP_TIME errors. Without the fix, the cancelled stop retains
...
class CancelledStopOnDelayedTripTest implements RealtimeTestConstants {
  ...
  void cancelledStopOnDelayedTripShouldApplyRealtimeTimes() {
    ...
    // Without the fix, C retains scheduled arrival 0:06 while B departs at 0:09 -> NEGATIVE_HOP_TIME
    var updates = siri
      .etBuilder()
