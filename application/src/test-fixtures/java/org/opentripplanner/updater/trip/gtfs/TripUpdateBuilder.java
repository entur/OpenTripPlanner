...
public class TripUpdateBuilder {
  ...
  /**
   * The {@code start_time} as the raw string the feed carries. GTFS times a trip that starts after
   * midnight past 24:00:00 on the previous service date - a form {@link LocalTime} cannot express -
   * and this also admits deliberately malformed values.
   */
  public TripUpdateBuilder withStartTime(String time) {
    tripDescriptorBuilder.setStartTime(time);
    return this;
  }
