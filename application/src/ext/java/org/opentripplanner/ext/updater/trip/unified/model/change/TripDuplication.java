 ...
 * {@link org.opentripplanner.ext.updater.trip.unified.service.TripDuplicator} drives it.
 */
public final class TripDuplication {
  ...
  public TripUpdateResult apply(DeduplicatorService deduplicator) {
    ...
    int newFirstDeparture = newStartTime.secondsPastMidnight();
  ...
  private FeedScopedId duplicatedTripId() {
    ...
    var localDateTime = serviceDate.atStartOfDay().plusSeconds(newStartTime.secondsPastMidnight());
