...
/**
 * Forwarding decorator for a {@link TimetableRepository} that adapts a batch-oriented handler
 ...
 */
public class RecordingTimetableRepository implements TimetableRepository {

  private final TimetableRepository delegate;
  ...
  public RecordingTimetableRepository(TimetableRepository delegate) {
  ...
  @Override
  public TimetableRepositorySnapshot createSnapshot() {
