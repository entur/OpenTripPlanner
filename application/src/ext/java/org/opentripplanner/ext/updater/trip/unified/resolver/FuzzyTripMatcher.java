 ...
 * <ul>
 *   <li>{@link org.opentripplanner.ext.updater.trip.unified.siri.SiriTripMatcher SiriTripMatcher} - SIRI-style matching by last stop arrival time</li>
 *   <li>{@link org.opentripplanner.ext.updater.trip.unified.gtfs.GtfsTripMatcher GtfsTripMatcher} - GTFS-RT-style matching by route/direction/start time</li>
 * </ul>
 * <p>
 * The matcher is called by {@link org.opentripplanner.ext.updater.trip.unified.factory.ExistingTripChangeFactory ExistingTripChangeFactory} when exact trip ID lookup fails
