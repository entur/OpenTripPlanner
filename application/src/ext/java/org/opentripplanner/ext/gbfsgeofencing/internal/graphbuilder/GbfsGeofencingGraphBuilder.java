...
public class GbfsGeofencingGraphBuilder implements GraphBuilderModule {
  ...
  public void buildGraph() {
    ...
    var applier = new GeofencingZoneApplier(graph::findEdges, anyFeedAppliesBusinessAreas);
  ...
  private List<GeofencingZone> loadGeofencingZonesFromFeed(
    ...
    var loaderAndMapper = new org.opentripplanner.gbfs.GbfsFeedLoaderAndMapper(
      feedParams,
      httpClientFactory
    );
