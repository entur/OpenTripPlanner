...
public class TripTimeDelayCsvParser extends AbstractCsvParser<TripTimeDelayRow> {
  ...
  private static final String MIN_PERCENTILE = "min_percentile";
  private static final String MAX_PERCENTILE = "max_percentile";
  ...
  protected TripTimeDelayRow createNextRow() throws HandledCsvParseException {
    return new TripTimeDelayRow(
      ...
      getInt(MIN_PERCENTILE, PERCENTILE_RANGE),
      getInt(MAX_PERCENTILE, PERCENTILE_RANGE)
    );
  }
}
