...
import org.opentripplanner.ext.empiricaldelay.internal.model.EmpiricalDelayByServiceId;
...
public class DefaultEmpiricalDelayRepository implements EmpiricalDelayRepository {
  ...
  private final Map<FeedScopedId, EmpiricalDelayByServiceId> empiricalDelays = new HashMap<>();
  ...
  @Override
  public void addEmpiricalDelay(
    FeedScopedId tripId,
    String serviceId,
    List<EmpiricalDelay> dalaysForEachStop
  ) {
    empiricalDelays
      .computeIfAbsent(tripId, ignore -> new EmpiricalDelayByServiceId())
      .put(serviceId, dalaysForEachStop);
  }
