 ...
 * cancellation supersedes whatever is queued or in flight for the trip. The queue also remembers
...
final class CarpoolTripResolutionQueue {
  ...
  /** Forgets whatever is queued or in flight for the trip; the caller removes it from the repository. */
  void cancel(FeedScopedId tripId) {
