...
class EmpiricalDelayRepositoryTest {
  ...
  void setup() {
    ...
    subject.addEmpiricalDelay(TRIP_ID, EVERYDAY, List.of(DELAY_STOP_1, DELAY_STOP_2, DELAY_STOP_3));
  }
  ...
  void empiricalDelay() {
    ...
    Assertions.assertThrows(ArrayIndexOutOfBoundsException.class, () ->
      subject.findEmpiricalDelay(TRIP_ID, DATE_INSIDE, -1)
    );
    Assertions.assertThrows(ArrayIndexOutOfBoundsException.class, () ->
      subject.findEmpiricalDelay(TRIP_ID, DATE_INSIDE, 3)
    );
  }
