...
class EmpiricalDelayCsvDataReaderTest {
  ...
  void read() {
    ...
    var calendarDataSource = DataStoreModule.dataSource(
      ...
      EMPIRICAL_DATA,
      """
      empirical_delay_service_id, trip_id, stop_id, stop_sequence, min_percentile, max_percentile
