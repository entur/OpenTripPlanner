...
public class TripUpdaterArchitectureTest {
  ...
  private static final Package MODEL_COMMAND = UNIFIED.subPackage("model").subPackage("command");
  private static final Package MODEL_CHANGE = UNIFIED.subPackage("model").subPackage("change");
