...
/**
 * Tests for {@link TripModifier}.
 * <p>
 * This operation processes MODIFY_TRIP updates which include:
 * <ul>
...
class TripModifierTest {
  ...
  class GtfsRtReplacementTests {
    ...
    void replacementTrip_withHeadsignChange() {
      ...
      var stopAUpdate = ParsedStopTimeUpdate.builder(
        ...
        .withArrivalUpdate(
          TimeUpdate.ofAbsolute(ServiceTime.ofSecondsPastMidnight(10 * 3600), null)
        )
        .withDepartureUpdate(
          TimeUpdate.ofAbsolute(ServiceTime.ofSecondsPastMidnight(10 * 3600), null)
        )
    ...
    void replacementTrip_invalidServiceDate() {
      ...
      var command = ModifyTrip.builder(tripRef, invalidDate)
        .withFormatPolicy(
          FormatPolicy.gtfsRt(ForwardsDelayPropagationType.NONE, BackwardsDelayPropagationType.NONE)
        )
        .addStopTimeUpdate(createStopUpdate("A", 0, 10 * 3600))
  ...
  class SiriExtraCallTests {
    ...
    // in TripModificationValidationTest since SIRI extra call validation moved to the factory.
