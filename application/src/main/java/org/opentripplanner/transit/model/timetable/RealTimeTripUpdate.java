 ...
 * @param revertPreviousRealTimeUpdates  signals the snapshot manager to revert any previous pattern
 *                                       modifications for this trip before applying the update.
 * @param scheduledPatternToDeleteFrom   when non-null, signals the snapshot manager to mark the trip
 *                                       as deleted in this pattern (prevents duplication when moving
