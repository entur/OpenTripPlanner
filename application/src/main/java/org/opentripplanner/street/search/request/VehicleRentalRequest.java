 ...
 */
public final class VehicleRentalRequest implements Serializable {

  public static final VehicleRentalRequest DEFAULT = new VehicleRentalRequest();
  ...
  private VehicleRentalRequest(Builder builder) {
   ...
   * it off.
   *
   * @see VehicleRentalRequest#arrivingInRentalVehicleAtDestinationCost()
   */
  ...
  public boolean equals(Object o) {
    ...
    VehicleRentalRequest that = (VehicleRentalRequest) o;
    return (
  ...
  public String toString() {
    return ToStringBuilder.of(VehicleRentalRequest.class)
  ...
  public static class Builder {
    ...
    private final VehicleRentalRequest original;
    ...
    private Builder(VehicleRentalRequest original) {
    ...
    public VehicleRentalRequest original() {
      return original;
    }
    ...
    public VehicleRentalRequest build() {
      var value = new VehicleRentalRequest(this);
