 ...
 */
class StateEdgeExtractor {

  record EdgesAndDistance(List<Edge> edges, double effectiveWalkDistance) {}
   ...
   */
  static EdgesAndDistance extractEdgesInChronologicalOrder(State state) {
    ...
    return new EdgesAndDistance(edges, effectiveWalkDistance);
  }
}
