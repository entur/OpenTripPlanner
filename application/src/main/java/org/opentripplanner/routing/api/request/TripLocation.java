 ...
 * quay, a stop place, a multimodal stop place or a group of stop places. Optionally, a
...
public record TripLocation(
  ...
  /**
   * Create a TripLocation identified by stop location ID and scheduled departure time (epoch
   * millis).
   */
  public static TripLocation of(
    TripOnDateReference tripOnDateReference,
    ...
    return new TripLocation(tripOnDateReference, stopLocationId, scheduledDepartureTime);
  }
}
