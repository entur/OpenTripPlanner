    ...
    return GraphQLInputObjectType.newInputObject()
      ...
      .description(
        "Identifies a point in a journey pattern by stop location ID and scheduled departure " +
          "time. A stop location can be a quay or a stop place. " +
          "The scheduled departure time is used for disambiguation when " +
          "the stop is visited more than once in the journey pattern (e.g. ring lines)."
      )
      .field(
        GraphQLInputObjectField.newInputObjectField()
          .name("stopLocationId")
          .description("The stop location ID. A stop location can be a quay or a stop place.")
