...
public class TransmodelRequestContext {
  ...
  private final @Nullable EmpiricalDelayService getEmpiricalDelayService;
  ...
  public TransmodelRequestContext(
    ...
    this.getEmpiricalDelayService = empiricalDelayService;
  }
  ...
  public EmpiricalDelayService getEmpiricalDelayService() {
    return getEmpiricalDelayService;
  }
}
