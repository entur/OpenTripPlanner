...
/**
 * The cancellation of a trip. The trip is still visible but marked as cancelled.
 * <p>
 * Maps to SIRI Cancellation=true or GTFS-RT CANCELED.
 */
public final class TripCancellation implements TripRemoval {
  ...
  public String toString() {
    return (
      "TripCancellation{" + "tripReference=" + tripReference + ", serviceDate=" + serviceDate + '}'
    );
  }
}
