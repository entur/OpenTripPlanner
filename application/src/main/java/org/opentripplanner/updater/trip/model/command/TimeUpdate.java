...
public sealed interface TimeUpdate
   ...
   *
   * @param time the real-time value in seconds since midnight
   * @param aimedTime the scheduled time in seconds since midnight, as reported by the feed, or
   *                  {@code null} if it did not report one
   */
  static AbsoluteTimeUpdate ofAbsolute(int time, @Nullable Integer aimedTime) {
