...
/**
 * Resolved data for removing a trip that a previous real-time message added (an extra journey).
 ...
 */
public final class ResolvedAddedTripRemoval extends ResolvedTripRemoval {
  ...
  public ResolvedAddedTripRemoval(
