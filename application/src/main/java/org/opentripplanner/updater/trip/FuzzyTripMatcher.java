 ...
 * <ul>
 *   <li>{@link SiriTripMatcher} - SIRI-style matching by last stop arrival time</li>
 *   <li>{@link GtfsTripMatcher} - GTFS-RT-style matching by route/direction/start time</li>
 * </ul>
 * <p>
 * The matcher is called by {@link ExistingTripChangeFactory} when exact trip ID lookup fails
