...
/**
 * Handles trip updates that duplicate an existing scheduled trip. Creates a copy of the
 ...
 */
public class DuplicateTripHandler implements TripUpdateHandler.ForDuplicateTrip {

  private final DeduplicatorService deduplicator;

  public DuplicateTripHandler(DeduplicatorService deduplicator) {
    this.deduplicator = Objects.requireNonNull(deduplicator);
  }

  @Override
  public TripUpdateResult handle(ResolvedDuplicateTrip resolvedUpdate) {
