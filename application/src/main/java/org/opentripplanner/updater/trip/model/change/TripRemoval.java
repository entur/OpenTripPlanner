 ...
 * current transit model, so {@link org.opentripplanner.updater.trip.factory.TripRemovalFactory} decides it
 ...
 * parameter: {@link org.opentripplanner.updater.trip.service.TripCanceller} and
 * {@link org.opentripplanner.updater.trip.service.TripDeleter} differ only in the real-time state the trip
