 ...
 * {@link DuplicateTripResolver} before the update reaches this class. The update itself is
 * applied by {@link ResolvedDuplicateTrip#apply} - this class only supplies the deduplicator
 * it needs.
 */
public class TripDuplicator {
  ...
  public TripUpdateResult duplicate(ResolvedDuplicateTrip resolvedUpdate) {
    return resolvedUpdate.apply(deduplicator);
  }
}
