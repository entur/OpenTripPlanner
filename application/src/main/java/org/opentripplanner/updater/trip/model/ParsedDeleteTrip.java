...
/**
 * Parsed update to delete a trip. Stronger than cancel — the trip is removed from routing.
 * <p>
 * Maps to GTFS-RT DELETED.
 */
public final class ParsedDeleteTrip implements ParsedTripRemoval {
  ...
  public String toString() {
    return (
      "ParsedDeleteTrip{" + "tripReference=" + tripReference + ", serviceDate=" + serviceDate + '}'
    );
  }
}
