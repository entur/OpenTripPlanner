...
import org.opentripplanner.updater.trip.model.change.AddedTripRemoval;
import org.opentripplanner.updater.trip.model.change.ScheduledTripRemoval;
 ...
 * transit model.
 * <p>
 * Used for CANCEL_TRIP ({@link org.opentripplanner.updater.trip.model.command.CancelTrip})
 * and DELETE_TRIP ({@link org.opentripplanner.updater.trip.model.command.DeleteTrip}).
 * <p>
