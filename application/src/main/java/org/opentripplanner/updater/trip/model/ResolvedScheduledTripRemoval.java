...
/**
 * Resolved data for removing a trip of the static schedule.
 * <p>
 * Note: extra call cancellations (SIRI messages with extra calls AND {@code isCancellation=true})
 * are not removals - they are handled by {@link org.opentripplanner.updater.trip.TripModifier}.
 */
public final class ResolvedScheduledTripRemoval extends ResolvedTripRemoval {
  ...
  public ResolvedScheduledTripRemoval(
