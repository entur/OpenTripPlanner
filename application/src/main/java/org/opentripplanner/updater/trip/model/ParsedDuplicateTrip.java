...
/**
 * Parsed update to duplicate an existing scheduled trip: create a copy of the trip running at a
 * new start time (and possibly on a different service date).
 * <p>
 * Maps to GTFS-RT DUPLICATED. SIRI-ET has no equivalent concept.
 */
public final class ParsedDuplicateTrip implements ParsedTripUpdate {
