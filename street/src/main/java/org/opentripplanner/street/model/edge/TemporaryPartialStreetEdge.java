...
public final class TemporaryPartialStreetEdge extends StreetEdge implements TemporaryEdge {
  ...
  TemporaryPartialStreetEdge(TemporaryPartialStreetEdgeBuilder builder) {
    super(builder);
    builder.fromVertex().copyRentalRestrictionsFrom(builder.parentEdge().getFromVertex());
    builder.toVertex().copyRentalRestrictionsFrom(builder.parentEdge().getToVertex());
