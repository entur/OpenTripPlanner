...
public class StreetEdge
   ...
   * CompactLineString#squaredDistanceToPointEquirectangular}. The square is returned because the
  ...
  public double squaredDistanceToPointEquirectangular(double lon, double lat, double xscale) {
    return CompactLineString.squaredDistanceToPointEquirectangular(
      fromv.getLon(),
      fromv.getLat(),
      tov.getLon(),
      tov.getLat(),
  ...
  private void setGeometry(LineString geometry) {
    this.compactGeometry = CompactLineString.compactLineString(
      fromv.getLon(),
      fromv.getLat(),
      tov.getLon(),
      tov.getLat(),
