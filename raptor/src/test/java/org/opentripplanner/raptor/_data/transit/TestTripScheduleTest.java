...
class TestTripScheduleTest {
  ...
  void relativeTravelTimeIsIdenticalAcrossTripsInTheSamePatternForEquivalentBoardingPositions() {
    assertEquals(trip1.relativeTravelTime(trip1.departure(0)), trip2.relativeTravelTime(trip2.departure(0)));
    assertEquals(trip1.relativeTravelTime(trip1.departure(1)), trip2.relativeTravelTime(trip2.departure(1)));
    assertEquals(trip1.relativeTravelTime(trip1.departure(2)), trip2.relativeTravelTime(trip2.departure(2)));
  }
}
